...
all of the elements/sets. A user could utilize the function `url_ref_element()`
 or `url_ref_set()` to add information to the BiocSet object. If a user has a 
question about a specific id then they can follow the reference url to get more 
informtion. Below is an example of using both functions to add reference urls to
