...
assay(se)$symbol <- mapIds(org.Hs.eg.db, keys = rownames(se), column = "SYMBOL", keytype = "ENSEMBL", multiVals = "first")

se$go <- mapIds(org.Hs.eg.db, keys = rownames(se), column = "GO", keytype = "ENSEMBL", multiVals = "first")

se$entrez <- mapIds(org.Hs.eg.db, keys = rownames(se), column = "ENTREZID", keytype = "ENSEMBL", multiVals = "first")
```
-->
