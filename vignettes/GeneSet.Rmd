...
tbl <- tibble(gene = asthma[[1]]$GENE[c(TRUE,FALSE)], set = rep(path[[1]], length(gene)))
tbl$ensembl <- mapIds(org.Hs.eg.db, keys = tbl$gene, column = "ENSEMBL", keytype = "ENTREZID", multiVals = "first")
