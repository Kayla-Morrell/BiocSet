...
## KEGG?
```
<!-- Discovering the asthma KEGG pathway -->
```{r kegg, message = FALSE}
library(KEGGREST)
#keggFind("pathway", "asthma")
#asthma <- keggGet("hsa05310")
## tibble with subset logical(true, false)
#asthma[[1]]$GENE

#keggConv("ncbi-geneid", tibble[1])

## numbers are entrez ids, map from entrez to ensembl
## this is the gene set to subset
```
